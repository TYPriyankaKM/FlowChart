...
var Handle = function (_a) {
    var _b = _a.type, type = _b === void 0 ? 'source' : _b, _c = _a.position, position = _c === void 0 ? exports.Position.Top : _c, _d = _a.isValidConnection, isValidConnection = _d === void 0 ? alwaysValid : _d, _e = _a.isConnectable, isConnectable = _e === void 0 ? true : _e, style = _a.style, className = _a.className, id = _a.id, onConnect = _a.onConnect;
    ...
    return (React__default['default'].createElement("div", { "data-handleid": handleId, "data-nodeid": nodeId, "data-handlepos": position, className: handleClasses, onMouseDown: onMouseDownHandler, style: style }));
};
